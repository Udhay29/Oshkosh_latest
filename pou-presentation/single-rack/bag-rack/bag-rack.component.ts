...
@Component({
  selector: 'pfep-bag-rack',
  templateUrl: './bag-rack.component.html',
  styleUrls: ['./bag-rack.component.scss']
})
export class BagRackComponent implements OnInit {
  selectedArr: String[];
  replaceValue: String;
  flagString: String = '';
  flag: boolean;
  ...
  addContainer(idx: number, data: string) {
    if (((this.maxItmPerRow === undefined || this.maxItmPerRow === '' || this.maxItmPerRow === null) && this.addRackItem && this.addRackItem['PRESENTATION_TYPE'] === 'Bag') ||
      (this.maxItmPerRow !== undefined &&
        this.addRackItem && (this[data][idx]['RackItems'].length + this.addRackItem['PICK_FACING_QNTY']) <= this.maxItmPerRow && this.addRackItem['PRESENTATION_TYPE'] === 'Bag')
        ) {
